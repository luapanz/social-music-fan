...
const StarProfile = (props) => {
  ...
  const [shareImage, updateShareImage] = useState('assets/images/profile.png')
  ...
  useEffect(() => {
    if (props.userDetails.avatar_photo && props.userDetails.avatar_photo.thumbnail_url) {
      updateShareImage(props.userDetails.avatar_photo.thumbnail_url)
    }
